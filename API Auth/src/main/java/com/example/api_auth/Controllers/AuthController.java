package com.example.api_auth.Controllers;

import com.example.api_auth.DTO.LoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity createUserCredentials(@RequestBody UserCredentials userCredentials){
        if (userCredentialsRepository.findByLogin(userCredentials.getLogin()) != null){
